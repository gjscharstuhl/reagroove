-- gjs - Save jam snapshot + quit REAPER
-- Saves current project into ~/jams/jam-YYYY-MM-DD-XX/
-- Copies used media into media/
-- Silent version
-- Quits REAPER without dialogs
