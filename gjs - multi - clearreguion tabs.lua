-- gjs - Delete all items and automation inside selected region
-- in all project tabs
-- selected region via GJS_MULTI / Region

local TOLERANCE = 0.000001

local REGION_NR =
  tonumber(reaper.GetExtState("GJS_MULTI", "Region"))
...
local function delete_automation_from_envelope(
  ...
  -- Losse envelope-punten verwijderen.
  ...
  -- Automation items verwijderen als ze de region overlappen.
    ...
    reaper.Undo_EndBlock2(
      ...
      changed
        and (
          "gjs - Clear region "
          .. REGION_NR
          .. " items and automation in all tabs"
        )
        or (
          "gjs - Clear region "
          .. REGION_NR
