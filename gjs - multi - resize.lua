-- GJS - Resize selected region to selected bar length
...
-- ActiveTrack 1 = tab 2, ActiveTrack 2 = tab 3, etc.
...
local function get_selected_region_track()
  ...
  local tr_idx = folder_nr -- IP_TRACKNUMBER is 1-based, GetTrack index is 0-based
...
if region then
  ...
  reaper.SetEditCurPos2(proj, old_start, true, false)
end

reaper.PreventUIRefresh(-1)
reaper.UpdateArrange()
reaper.Undo_EndBlock2(proj, "Resize selected region to " .. BARS .. " bars and trim items", -1)
