...
return function(api)
    ...
    local function open_edit()
        -- Main is the single source of truth when entering Edit.
        -- Copy exactly the two radio selections that are visible on Main:
        -- bottom row = track, third row from the top = region.
